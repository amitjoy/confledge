...
const Save = (props: SVGProps<SVGSVGElement>) => (
    ...
    <svg viewBox="-2 0 32 32" version="1.1" {...props}>
        <title>arrow-bottom</title>
        <desc>Created with Sketch Beta.</desc>
        <defs>
        </defs>
        <g id="Page-1" fillRule="evenodd" strokeWidth={1} fill={props.color} stroke={props.color}>
            <g id="Icon-Set" transform="translate(-519.000000, -931.000000)" fill={props.color}>
                <path
